...
find_and_run_py_files(r"web-crawler\建设项目公示网站")

py_file_path = r'web-crawler\建设项目公示网站\01_del_empty_folder.py'
subprocess.run(["python", py_file_path], check=True)

py_file_path = r'web-crawler\建设项目公示网站\02_move_folder_hz.py'
subprocess.run(["python", py_file_path], check=True)

py_file_path = r'web-crawler\建设项目公示网站\02_move_folder_sh.py'
subprocess.run(["python", py_file_path], check=True)
