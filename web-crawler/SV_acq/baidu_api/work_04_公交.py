...
df_point = pd.read_csv(csv_path)

file_paths = [
    # r'上海市POI数据_餐饮店_咖啡店.csv',
    # r'上海市POI数据_公交站.csv',
    # r'上海市POI数据_公园_广场.csv',
    # r'上海市POI数据_故居_博物馆_纪念馆_no_parking.csv',
    # r'上海市POI数据_商场.csv',
    # r'上海市POI数据_手工艺品店_零售店_商店.csv',
    # r'上海市POI数据_停车场.csv',
    # r'上海市POI数据_小区_no_parking.csv',

    r'上海市POI数据_住宅区_别墅区.csv',

    # r'上海市POI数据_医院_诊所.csv',
    # r'上海市POI数据_运动.csv'
  ]

for poi_name in file_paths:

    poi_folder = r'f:\2022poi\2022POI\华东poi1\上海市'
    df_gongjiao_path = os.path.join(poi_folder, poi_name)

    df_gongjiao_path = r'f:\地学大数据\2024年华东地区POI数据（上海、江苏、浙江、安徽）\上海市\上海市POI数据_住宅区_别墅区.csv'
    df_gongjiao = pd.read_csv(df_gongjiao_path)
