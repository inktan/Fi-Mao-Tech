...
with open(csv_path ,'w',encoding='utf-8' ,newline='') as f:
    writer = csv.writer(f)
    writer.writerow(['id','address','lng_bd09','lat_bd09','lng_gcj02', 'lat_gcj02','lng_wgs84', 'lat_wgs84'])
...
for i,row in enumerate(tqdm(df.iterrows())):
    ...
    rate_list = [row[1]['id'],input_string,lng_bd09,lat_bd09,lng_gcj02, lat_gcj02,lng_wgs84, lat_wgs84]
