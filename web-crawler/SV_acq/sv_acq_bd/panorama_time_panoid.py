...
def main():
    ...
    result_cache_path = r'D:\Users\wang.tan.GOA\WeChat Files\wxid_0431434314115\FileStorage\File\2024-09\aomen\result_cache'
    folder_out_path = r'D:\Users\wang.tan.GOA\WeChat Files\wxid_0431434314115\FileStorage\File\2024-09\aomen'
    if os.path.exists(result_cache_path) == False:
        os.makedirs(result_cache_path)

    get_streetview(result_cache_path ,'09010700121808240959384418V',x_count,y_count)
