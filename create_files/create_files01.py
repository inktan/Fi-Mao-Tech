...
def modify_and_create_files(template_file, output_dir, total_range, interval):
    ...
    for i in range(num_files):
        ...
        modified_content = template_content.replace(
            ...
            f"output_ = r'/content/gdrive/MyDrive/work_fimo/svi_taiwan/sv_pano_{start}_{end}'"
        )
...
if __name__ == "__main__":
    template_file = r"/content/gdrive/MyDrive/work_fimo/work_tw_20250816/code_py/google_panorama_new.py" # 替换为你的模板文件路径
    output_directory = r"/content/gdrive/MyDrive/work_fimo/work_tw_20250816/code_py/output_scripts" # 输出目录
