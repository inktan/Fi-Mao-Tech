...
if __name__ == '__main__':
    ...
    folder_path_template = r'Y:\GOA-AIGC\98-goaTrainingData\ArchOctopus\archina-20241012'
    
    df = pd.read_csv(r'D:\Ai-clip-seacher\AiArchLib\archina-1-1492-2024-10-12.csv')
