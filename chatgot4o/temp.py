...
if __name__ == '__main__':
    # 文件夹路径
    csv_path = r'e:\work\spatio_evo_urbanvisenv_svi_leo371\风貌评估-gpt4o\ai-分析数据\分析数据\街道分类\林芝点位.csv' # 需要爬取的点
    folder_out_path = r'e:\work\spatio_evo_urbanvisenv_svi_leo371\风貌评估-gpt4o\ai-分析数据\分析数据\街道分类\sv_林芝点位' # 保存街景文件
