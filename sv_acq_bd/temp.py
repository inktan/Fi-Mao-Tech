...
if __name__ == '__main__':
    # 文件夹路径
    csv_path = r'/home/ubuntu/SV_acq/points01_panoid02/丽水市_100msv_infos_.csv' # 需要爬取的点
    folder_out_path = r'/home/ubuntu/SV_acq/sv_丽水市_100m' # 保存街景文件
