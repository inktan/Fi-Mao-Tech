...
def draw_results_on_image(image_path, calculated_results, output_path):
    ...
    for res in calculated_results:
        ...
        info_text = (f"tree height: {res['total_height']}m\n"
                     f"canopy height: {res['crown_height']}m\n"
                     f"canopy width: {res['crown_width']}m\n"
                     f"DBH: {res['dbh_diameter']}m")
...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = r'E:\work\sv_pangpang\sv_pano_20260218\enriched_results'
