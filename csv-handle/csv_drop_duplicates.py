...
ids_csv_path = r'f:\work\sv_ran\ss_rgb_fisheye_shp\sv_points_surrounding_pd_pf.csv'
...
output_csv_path =  r'f:\work\sv_ran\ss_rgb_fisheye_shp\sv_points_surrounding_pd_pf01.csv'
