...
input_file = r'd:\BaiduNetdiskDownload\sv_leo371\山南、林芝传统商业街区风貌得分.csv'
input_files.append(input_file)
# input_file = r'd:\BaiduNetdiskDownload\sv_leo371\拉萨传统商业街区风貌得分.csv'
# input_files.append(input_file)
...
for i in input_files:
    ...
    if 'id' in df.columns:
        for id_value in df['id']:
            print(id_value)
            # 源文件路径
            # src_file = r'D:\BaiduNetdiskDownload\sv_leo371\拉萨市传统商业街区街景\\' + id_value +'.jpg'
            src_file = r'D:\BaiduNetdiskDownload\sv_leo371\山南、林芝传统商业街景\\' + id_value +'.jpg'
            print(src_file)
            # 目标文件夹路径
            dst_folder = r'D:\BaiduNetdiskDownload\sv_leo371\ai\sv_jpg'
            # 确保目标文件夹存在
