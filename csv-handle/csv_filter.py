...
import shutil
# 1. 读取 CSV 文件
input_file = r'e:\work\spatio_evo_urbanvisenv_svi_leo371\街道分类\街景\ss_山南_a01.csv'
df = pd.read_csv(input_file)

# 筛选score列大于1的行
filtered_df = df[df["building;edifice"] > 0.1 ]
print(filtered_df)

folder01 = r'E:\work\spatio_evo_urbanvisenv_svi_leo371\街道分类\街景\sv_山南'
folder02 = r'E:\work\spatio_evo_urbanvisenv_svi_leo371\街道分类\街景\sv_山南_a01'
