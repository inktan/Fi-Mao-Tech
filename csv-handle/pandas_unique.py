...
df = pd.read_csv(r'Y:\GOA-AIGC\02-Model\安装包\stru\sv_拉萨_cluster_colors001.csv')
print(df.shape)
print(df.head(5))
...
df_unique.to_csv(r'Y:\GOA-AIGC\02-Model\安装包\stru\sv_拉萨_cluster_colors002.csv', index=False)
