...
# 打开SHP文件
shp_file_path = r"e:\work\sv_xiufenganning\20250819\buffer_analysis_result_08.shp"  # 替换为你的SHP文件路径
...
gdf['FacCol_Vis'] = mean_values + np.random.uniform(-0.1, 0.1, size=len(gdf))

# 确保新值在合理范围内（例如0-1之间，如果需要）
# gdf[['Histor_Vis', 'Faccon_Vis', 'Block_Vis']] = gdf[['Histor_Vis', 'Faccon_Vis', 'Block_Vis']].clip(0, 1)

# 保存修改后的文件
gdf.to_file(r"e:\work\sv_xiufenganning\20250819\buffer_analysis_result_09.shp")  # 替换为你想要的输出路径