...
def main():
    ...
    categories= ['320','480','640']

    for tar_train in categories:
        epochs = 20
        batch_size = 5

        train_folder =os.path.join(r'F:\lcz\lcz_train',tar_train)  # split into training(80%) and validation(20%)
        ...
        torch.save(model, f'F:\lcz\lcz_train/lcz_{tar_train}_.pth')
