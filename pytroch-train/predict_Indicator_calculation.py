...
if __name__ == "__main__":
    categories= ['arch_style']
    batch_size = 5
    predictn_folder = r'E:/sv/build-HEB/build-HEB'  # split into training(80%) and validation(20%)
    predict_csv= f"E:/sv/arch_style/{categories[0]}.csv"
    model_path= f"E:/sv/arch_style/{categories[0]}_.pth"
