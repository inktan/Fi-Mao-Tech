...
def train(model, device, train_loader, validation_loader, epochs):
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():  # 告诉pytorch，此段不需要构建计算图，更加安全
            for batchidx_val, dt_val in tqdm(enumerate(validation_loader)):
...
def main():
    ...
    for i in range(1):
        ...
        # csv_file = f'e:\work\sv_zhoujunling\modified_file.csv'
        # img_dir = f''
        ...
        # ]
        # model = models.convnext.ConvNeXt(block_setting,num_classes=287)

        # model_path= f'e:\work\sv_zhoujunling\{tar_train}_.pth'
        # model = torch.load(model_path)   
        
        # 加载预训练的ConvNeXt模型
        # ConvNeXt Tiny：大约有530万参数
        # ConvNeXt Small：大约有880万参数
        # ConvNeXt Base：大约有1.5亿参数
        # ConvNeXt Large：大约有3亿参数
        ...
        # torch.save(model, f'e:\work\sv_zhoujunling\{tar_train}_01.pth')
