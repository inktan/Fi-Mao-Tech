    ...
    for j in tqdm(range(len(id_lst))):
        ...
        try:
            ...
            for i in range(len(filtered_panoramas)):
                ...
                # save_file_path = folder_out_path + '/' + str(id)+'_' +str(lng)+'_' +str(lat)+ '_' +timeLine+ '.jpg'
                save_file_path = folder_out_path + '/' + str(id)+ '_' +timeLine+ '.jpg'
...
if __name__ == '__main__':
    ...
    folder_out_path = r'/home/ubuntu/SV_acq/sv_points' # 保存街景文件
